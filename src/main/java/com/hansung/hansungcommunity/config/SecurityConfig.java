...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests()
                ...
                .antMatchers(HttpMethod.GET, "/api/notice/main").permitAll()
                .antMatchers(HttpMethod.GET, "/api/notice/list").permitAll()
                .antMatchers(HttpMethod.GET, "/api/notice/detail/**").permitAll()
                .antMatchers(HttpMethod.GET, "/api/notice/**/file-list").permitAll()
