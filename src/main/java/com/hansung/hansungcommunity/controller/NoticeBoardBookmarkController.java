...
@RequestMapping("/api")
public class NoticeBoardBookmarkController {
     ...
     * 북마크 등록
     */
    @PostMapping("/notice/{boardId}/bookmark")
     ...
     * 북마크 취소
     */
    @DeleteMapping("/notice/{boardId}/bookmark")
     ...
     */
    @GetMapping("/notice/{boardId}/bookmark-check")
     ...
     * 해당 게시글의 북마크수 조회
     */
    @GetMapping("/notice/{boardId}/bookmark-count")
